...
import com.tony_fire.xprogramstesla.databinding.ActivityRegistrationBinding
...
class RegistrationActivity : AppCompatActivity() {
    ...
    private fun userField() {
        binding.regButton.setOnClickListener {
            ...
            val userinfo = UserInfo(countrypicker,ed_email,ed1stName,"5f4d230a3d18cbe61980ae3a",ed2stName,ed_tel,"zaxsdweess")
